...
object MonthProgressWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        provideContent {
            ...
            val formattedValue =
                String.format(Locale.US, "%.2f", calculateMonthProgress().toFloat() * 100)
            ...
            Column(
                ...
                Row(modifier = GlanceModifier.fillMaxWidth()) {
                    ...
                    Text(
                        text = currentMonth.toString().substring(0, 3),
                        style = TextStyle(
                            color = ColorProvider(Color.White),
                            fontSize = 12.sp,
                        ),
                ...
                LinearProgressIndicator(
                    ...
                    progress = calculateMonthProgress().toFloat(),
